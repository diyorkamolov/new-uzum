...
export default function PrimarySearchAppBar() {
    ...
    return (
        <Box sx={{ flexGrow: 20 }}>
            <AppBar position="static" sx={{ bgcolor: "#fff", height: "100px", boxShadow: '0' }}>
                <Toolbar>
                    ...
                    <Search style={{ background: "#FFFFFF", border: "rgb(133, 141, 141)", width: "30%" }}>
                        <SearchIconWrapper style={{ backgroundColor: "lightgray" }}>
                            <SearchIcon />
                        </SearchIconWrapper>
                        <StyledInputBase
